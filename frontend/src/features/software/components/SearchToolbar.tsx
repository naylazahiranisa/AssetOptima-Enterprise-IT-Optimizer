...
const sortOptions: { field: SortField; label: string }[] = [
  { field: "software_name", label: "Name" },
  { field: "renewal_date", label: "Renewal Date" },
  { field: "monthly_cost", label: "Monthly Cost" },
  { field: "used_licenses", label: "License Usage" },
  ...
  return (
    ...
    >
      <div className="relative min-w-[200px] flex-1">
        ...
        <input
          type="text"
          placeholder="Search software by name, vendor, department..."
          value={search}
